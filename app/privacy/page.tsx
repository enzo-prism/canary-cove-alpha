...
export const metadata: Metadata = {
  ...
  description:
    "How Canary Cove handles contact details, booking requests, analytics, and embedded third-party services.",
}
      ...
      <Section padding="tight">
        <Container size="narrow" className="flow flow-md">
          ...
          <section className="flow flow-sm">
            ...
            <p className="text-body text-foreground/80">
              Canary Cove uses Formspree to receive submitted forms, Bookingmood to display live availability, Cloudinary to serve media, and Vercel Analytics to understand site usage. Those providers may process information according to their own policies.
            </p>
          </section>
