...
const stayGalleryItems = [
  ...
  { ...IMAGES.heroVillaSeating, caption: "Villa seating" },
  { ...IMAGES.heroVillaLounge, caption: "Open-air lounge" },
  { ...IMAGES.heroVillaDining, caption: "Dining table" },
  { ...IMAGES.heroVillaLiving, caption: "Living space" },
  { ...IMAGES.heroVillaDetail, caption: "Lounge detail" },
  { ...IMAGES.heroVillaInterior, caption: "Interior view" },
