...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/experiences/power-boating", destination: "/experiences#diving-fishing", permanent: true },
      { source: "/experiences/land", destination: "/experiences#on-the-water", permanent: true },
