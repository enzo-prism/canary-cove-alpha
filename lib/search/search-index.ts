...
export const SEARCH_ITEMS: SearchItem[] = [
  ...
  },
  {
    ...
    keywords: ["sleeps", "guests", "bed setup", "king suites", "bunk room", "queen sleeper", "capacity", "up to 10", "family", "occupancy"],
    intent: "amenities",
    type: "section",
  },
  {
  ...
  },
  {
    ...
    group: "Adventures, boats & add-ons",
    keywords: ["snorkeling", "diving", "nitrox", "paddle boards", "kayaks", "sailing", "hobie cat", "scuba price", "$100", "$125"],
    intent: "adventures",
    type: "section",
  },
  {
  ...
  },
  {
    ...
    group: "Pricing & availability",
    keywords: ["dates", "quote", "reserve", "book now", "availability form", "check dates"],
    intent: "pricing",
    type: "section",
  },
  {
    id: "main-house-stay",
    title: "Main House stay for returning groups",
    description: "The full 5-suite estate as one home base, from $2,500 a night in low season.",
    href: "/stay#main-house-stay",
    group: "Pricing & availability",
    keywords: ["main house", "reunion", "large group", "5 suites", "returning guests", "whole estate"],
    intent: "pricing",
    type: "section",
  },
  {
    id: "spa-extras-on-request",
    title: "Spa services & extras on request",
    description: "Spa services, childcare, and provisions planned around your group.",
    href: "/stay#amenities",
    group: "What’s included & extra costs",
    keywords: ["spa", "massage", "childcare", "extras on request", "provisions"],
    intent: "included",
    type: "section",
  },
  {
    id: "guest-experience-stay",
    title: "Guest experience & reviews",
    description: "How the stay feels once you arrive, in recent guests’ own words.",
    href: "/stay#guest-experience",
    group: "Villa, amenities & comfort",
    keywords: ["reviews", "testimonials", "guests say", "guest experience", "arrival", "hosting"],
    intent: "amenities",
    type: "section",
  },
  {
    ...
    description: "Every photograph of the estate, from suites to reef days.",
    href: "/gallery",
    group: "Villa, amenities & comfort",
    keywords: ["photos", "pictures", "video", "tour", "gallery", "images"],
    intent: "amenities",
    type: "page",
  },
  {
    id: "reviews-overview",
    title: "Guest reviews archive",
    description: "Fourteen years of guestbook notes from private stays in Belize.",
    href: "/reviews",
    group: "Villa, amenities & comfort",
    keywords: ["reviews", "guestbook", "testimonials", "ratings", "guest notes"],
    intent: "amenities",
    type: "page",
  },
  {
    ...
    description: "Half-day and full-day carts for flexible San Pedro runs.",
    href: "/rates#golf-cart-rentals",
    group: "Getting here & getting around",
    keywords: ["golf cart", "island transport", "san pedro runs", "$50", "$80", "town transport"],
    intent: "getting-around",
    type: "section",
  },
  {
    id: "on-the-water",
    title: "On-the-water experiences",
    description: "Snorkel, sail, kayak, and paddle straight from the estate’s docks.",
    href: "/experiences#on-the-water",
    group: "Adventures, boats & add-ons",
    keywords: ["snorkel", "sail", "kayak", "paddle", "on the water", "dock departures"],
    intent: "adventures",
    type: "section",
  },
  {
    id: "diving-fishing-experiences",
    title: "Diving & fishing experiences",
    description: "Guided scuba, reef days, and fishing charters arranged from the dock.",
    href: "/experiences#diving-fishing",
    group: "Adventures, boats & add-ons",
    keywords: ["scuba", "dive", "fish", "fishing charter", "reef day", "guided dive"],
    intent: "adventures",
    type: "section",
  },
  {
    id: "boat-fishing-addons",
    title: "Boat runs, fishing & reef add-ons",
    description: "One searchable list of transfers, charters, dive days, carts, and included gear.",
    href: "/rates#additional-services",
    group: "Adventures, boats & add-ons",
    keywords: ["boat runs", "fishing charters", "reef add-ons", "dive days", "add-ons", "transfers"],
    intent: "adventures",
    type: "section",
  },
]
